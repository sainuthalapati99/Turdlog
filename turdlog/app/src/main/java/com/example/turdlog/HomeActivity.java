...
public class HomeActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    // A default location (GSU, Georgia, USA) and default zoom to use when location permission is
    // not granted.
    private final LatLng mDefaultLocation = new LatLng(33.7560837, -84.3892877);
